...
const app = express();
//QUEDO POR EL ✅ Batch 2706 completado (27060/58650)
// --- Agent para ignorar certificados SSL vencidos ---
...
async function safeFetch(url, options = {}) {
    try {
        ...
        // añadir el agent inseguro a ESTA petición
        const res = await fetch(url, {
            ...options,
            agent: unsafeAgent     // ← OBLIGA a ignorar certificados
        });
...
async function tryLogin({ telegramId, tokenOptions, loginOptions }) {
    ...
    const [loginValue, loginError] = await safeFetch(
        "https://www.pantallazo.store/api/login",
